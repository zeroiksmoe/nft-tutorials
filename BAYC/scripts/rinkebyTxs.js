async function main(){
    ...
    // const options = {value: ethers.utils.parseEther("0.00000001"), gasPrice: feeData.gasPrice }
    // let tx = await baycContractInstanceWithSigner.mintApe(1, options);

    // Set/Read BaseURI
    // const tx = await baycContractInstanceWithSigner.setBaseURI("")
    // console.log(await baycContractInstanceWithSigner.baseURI());
